...
class MfccTimeDistributedRnnEncoder(ZEncoder):
  ...
  def __init__(self,
    ...
    self.mel_samples = mel_samples

  def compute_z(self, audio):
    print("Computing mfccs and latent z from input audio: ", audio.shape)
...
class ResnetSinusoidalEncoder(nn.DictLayer):
  ...
  def call(self, audio):
    ...
    print("resnetSinusoidal, after compute log mel function: ", mag)
